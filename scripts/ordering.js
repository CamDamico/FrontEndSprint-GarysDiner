function calculateTotal()
{
  ...
  item_price.BatteredWings = ($("#qty_BatteredWings").val() * unit_price.BatteredWings )
  ...
  item_price.ChocolateFudgeBrownie = ($("#qty_Brownie").val() * unit_price.ChocolateFudgeBrownie )
  $("#price_Brownie").val(item_price.ChocolateFudgeBrownie);  
  
  let total = item_price.BatteredWings + item_price.ChickenSalad + item_price.BigGary + item_price.Fries + item_price.RaspberryTart + item_price.ChocolateFudgeBrownie;
